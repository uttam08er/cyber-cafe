      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="card">
              <h2 className="font-bold text-surface-900 mb-5 text-lg font-display">
                Contact Information
              </h2>
                  ...
                  <li key={label} className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      {href ? (
                        ...
                        <p className="text-sm text-surface-800 font-medium whitespace-pre-line">
                          {value}
                        </p>
                      )}
                    </div>
            ...
            <div className="card bg-green-50 border-green-200">
              ...
              <p className="text-sm text-green-700 mb-4">
                Need immediate help? Chat with us directly on WhatsApp for
                fastest response.
              </p>
              <a
                href={WhatsApp()}
          ...
          <div className="lg:col-span-3">
            {sent ? (
              ...
              <div className="card">
                <h2 className="font-bold text-surface-900 mb-6 text-lg font-display">
                  Send a Message
                </h2>
